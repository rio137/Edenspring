...
<div id="mySidenav" class="sidenav fixed-top">
  ...
  <a href="index1.php" id="hom">Home</a>
</div>
...
$id = $_SESSION['abc'];
$selectquery = "select * from photography where user_id = $id";
...
while($res = mysqli_fetch_array($query)){  
    ...
    <tr>
                            ...
                            <td><a href="phtgphydlt.php?id=<?php echo $res['id']; ?>" data-toogle = "tooltip" data-placement="bottom"
...
mysqli_select_db($con,'userregi');
$id1 = $_SESSION['abc'];
$selectquery1 = "select * from catering where user_id = $id1";
...
while($res1 = mysqli_fetch_array($query1)){  
    ...
    <tr>
                            ...
                            <td><a href="cateringdlt.php?id=<?php echo $res1['id']; ?>" data-toogle = "tooltip" data-placement="bottom"
                            title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
...
mysqli_select_db($con,'userregi');
$id2 = $_SESSION['abc'];
$selectquery2 = "select * from rent where user_id = $id2";
...
while($res2 = mysqli_fetch_array($query2)){  
    ...
    <tr>
                            ...
                            <td><a href="rentdlt.php?id=<?php echo $res2['id']; ?>" data-toogle = "tooltip" data-placement="bottom"
                            title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
...
mysqli_select_db($con,'userregi');
$id3 = $_SESSION['abc'];
$selectquery3 = "select * from venue where user_id = $id3";
...
while($res3 = mysqli_fetch_array($query3)){  
    ...
    <tr>
                            ...
                            <td><a href="venuedlt.php?id=<?php echo $res3['id']; ?>" data-toogle = "tooltip" data-placement="bottom"
                            title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
...
mysqli_select_db($con,'userregi');
$id4 = $_SESSION['abc'];
$selectquery4 = "select * from decoration where user_id = $id4";
...
while($res4 = mysqli_fetch_array($query4)){  
    ...
    <tr>
                            ...
                            <td><a href="dcrtndlt.php?id=<?php echo $res4['id']; ?>" data-toogle = "tooltip" data-placement="bottom"
                            title="DELETE"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
